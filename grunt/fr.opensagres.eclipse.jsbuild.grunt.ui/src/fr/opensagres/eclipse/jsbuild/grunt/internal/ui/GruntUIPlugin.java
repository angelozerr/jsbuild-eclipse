 ...
 */
public class GruntUIPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "fr.opensagres.eclipse.jsbuild.grunt.ui"; //$NON-NLS-1$

	// The shared instance
	private static GruntUIPlugin plugin;

	/**
	 * The constructor
	 */
	public GruntUIPlugin() {
	}
	 ...
	 */
	public static GruntUIPlugin getDefault() {
		return plugin;
	}
