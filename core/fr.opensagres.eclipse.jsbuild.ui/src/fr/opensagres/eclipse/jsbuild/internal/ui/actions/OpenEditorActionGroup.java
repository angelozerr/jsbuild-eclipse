...
public class OpenEditorActionGroup extends ActionGroup {
	 ...
	 * <code>"fr.opensagres.eclipse.jsbuild.edit.text.task.open.editor"</code>).
	 */
	public static final String OPEN_EDITOR = "fr.opensagres.eclipse.jsbuild.ui.edit.text.task.open.editor"; //$NON-NLS-1$

	/**
	 * Navigate menu: name of standard Open global action (value
	 * <code>"fr.opensagres.eclipse.jsbuild.ui.actions.Open"</code>).
	 */
	public static final String OPEN = "fr.opensagres.eclipse.jsbuild.ui.actions.Open"; //$NON-NLS-1$
	 ...
	 */
	/*
	 * public OpenEditorActionGroup(JavaEditor editor) { fIsEditorOwner= true;
	 * fOpen= new OpenAction(editor);
	 * fOpen.setActionDefinitionId(IJavaEditorActionDefinitionIds.OPEN_EDITOR);
	 * editor.setAction("OpenEditor", fOpen); //$NON-NLS-1$ fSite=
	 * editor.getEditorSite(); initialize(fSite.getSelectionProvider()); }
	 */
	...
	private void setGlobalActionHandlers(IActionBars actionBars) {
		actionBars.setGlobalActionHandler(OPEN /* JdtActionConstants.OPEN */, fOpen);
	}
