...
public class ImageResource {
	...
	public static final String IMG_GULPFILE = "gulpfile";
	...
	static {
		try {
			...
			ICON_BASE_URL = GulpUIPlugin.getDefault().getBundle()
					.getEntry(pathSuffix);
		} catch (Exception e) {
	...
	protected static void initializeImageRegistry() {
		imageRegistry = GulpUIPlugin.getDefault().getImageRegistry();
		imageDescriptors = new HashMap<String, ImageDescriptor>();

		// load general object images
		registerImage(IMG_GULPFILE, URL_OBJ + IMG_GULPFILE + ".png");
